...
function initDeleteAction() {
    ...
    if(btnDelete) {
        btnDelete.addEventListener('click', function() {
            ...
            const name = document.getElementById('table_name').value; // Lấy tên bàn để hiển thị
            
            // Trường hợp 1: Chưa chọn bàn
            if(!id) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Chưa chọn bàn!',
                    text: 'Vui lòng click vào một bàn trong danh sách bên phải để chọn.',
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-start fs-6">
                        ...
                        <p class="mb-0 text-muted fst-italic small">Lưu ý: Lịch sử đơn hàng cũ của bàn này vẫn được giữ nguyên để thống kê.</p>
                    </div>
                `,
                icon: 'warning',
