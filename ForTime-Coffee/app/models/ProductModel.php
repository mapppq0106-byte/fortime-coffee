...
class ProductModel {
    ...
    public function getToppings() {
        ...
        // - Điều kiện 2: Đang bán (is_available = 1).
        // - Điều kiện 3: Chưa bị xóa (is_deleted = 0).
    ...
    public function checkNameExists($name, $excludeId = null) {
        // [QUERY] Soạn thảo SQL cơ bản: Tìm ID món có tên trùng và chưa xóa.
    ...
    public function addProduct($data) {
        ...
        // Dùng các ký hiệu :name, :cat_id... (Placeholder) để giữ chỗ an toàn.
    ...
    public function restoreProduct($id) {
        ...
        // Đồng thời set is_available = 0 (Ngừng bán) để an toàn, Admin phải tự bật lại.
        $sql = "UPDATE products SET is_deleted = 0, is_available = 0 WHERE product_id = :id";
