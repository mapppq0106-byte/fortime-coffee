            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <form action="" method="GET" class="row g-3 align-items-end">
                        <div class="col-md-3">
                            <label class="form-label fw-bold">Ngày xem:</label>
                            <input type="date" name="date" class="form-control" value="<?php echo $data['date_filter']; ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Tìm nhân viên:</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-search"></i></span>
                                <input type="text" name="search" class="form-control" placeholder="Nhập tên..." value="<?php echo htmlspecialchars($data['search_keyword']); ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo URLROOT; ?>/AdminAttendance" class="btn btn-outline-secondary w-100">Hôm nay</a>
                        </div>
                    </form>
                </div>
            </div>
